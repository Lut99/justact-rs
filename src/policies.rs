...
use crate::collections::map::InfallibleMap;
use crate::collections::set::{InfallibleSet, Set};
    ...
    C: ?Sized,
{
    ...
    /// parse.
    fn extract<'m, M: Message<AuthorId = A, Payload = C>>(&self, msgs: &'m impl Set<M>) -> Result<Self::Policy<'m>, Self::Error<'m>>;
}
